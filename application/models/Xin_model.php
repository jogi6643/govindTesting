...
class xin_model extends CI_Model {
	...
	// get single location
	 ...
	 public function read_location_info_array($id) {
	...
	public function read_user_info_array($id) {
		...
		public function reporting_officer($id){
	...
	public function read_company_info($id) {
		...
		public function read_company_info_array($id) {
		$condition = "company_id =" . "'" . $id . "'";
		$this->db->select('*');
		$this->db->from('xin_companies');
		$this->db->where($condition);
	...
	public function site_title() {
		...
		$query = $this->db->get();
		return $query->result_array();
		//return 'e-File Management Sytem';
	}
	...
	public function all_reporting_employees(){
		$this->db->select('*');
		$this->db->from('xin_employees');
	...
	public function update_employee_password($user_email, $data){
