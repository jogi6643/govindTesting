...
<div class="site-sidebar">
    ...
    <ul class="sidebar-menu">
      ...
      <li class="with-sub"> <a href="javascript:void(0);" class="waves-effect  waves-light"> <span class="s-caret"><i class="fa fa-angle-down"></i></span> <span class="s-icon"><i class="fa fa-building-o"></i></span> <span class="s-text"><?php echo $this->lang->line('left_organization');?></span> </a>
        <ul>
          ...
          <li><a href="<?php echo site_url();?>grade"><?php echo "Grade";?></a></li>
          <?php } ?>     
          ...
          <li><a href="<?php echo site_url();?>announcement"><?php echo $this->lang->line('xin_circulars');?></a></li>
          <?php } ?>
          ...
          <li><a href="<?php echo site_url();?>managing_directive"><?php echo $this->lang->line('left_managing_directive');?></a></li>
          <?php } ?>
          <?php  if(in_array('10',$role_resources_ids)) { ?>
          <li><a href="<?php echo site_url();?>expense"><?php echo $this->lang->line('left_manual');?></a></li>
          <?php } ?>
        </ul>
      </li>
      <?php } ?>
      <?php if($role_user[0]->role_id ==1) { if(in_array('11',$role_resources_ids) || in_array('13',$role_resources_ids) || in_array('14',$role_resources_ids) || in_array('15',$role_resources_ids) || in_array('16',$role_resources_ids) || in_array('17',$role_resources_ids) || in_array('18',$role_resources_ids) || in_array('19',$role_resources_ids) || in_array('20',$role_resources_ids) || in_array('21',$role_resources_ids) || in_array('22',$role_resources_ids) || in_array('23',$role_resources_ids) || in_array('24',$role_resources_ids) || in_array('25',$role_resources_ids) || in_array('26',$role_resources_ids) || in_array('27',$role_resources_ids)){?>
  ...
  <!--    <?php if(in_array('240',$role_resources_ids) || in_array('24',$role_resources_ids) || in_array('25',$role_resources_ids)){?>
   ...
   -->   <?php } ?>
      ...
      <li> <a href="<?php echo site_url('project');?>" class="waves-effect waves-light"> <span class="s-icon"><i class="ti-layers-alt"></i></span> <span class="s-text"><?php echo $this->lang->line('left_document_diary');?></span> </a> </li>
      <?php } ?>
<!--  <?php  if(in_array('7',$role_resources_ids)) { ?>
      ...
      <?php } ?>
 -->	  
	  <?php if($role_user[0]->role_id==1) { if(in_array('100',$role_resources_ids) || in_array('101',$role_resources_ids) || in_array('102',$role_resources_ids)){?>
      <li style="" class="with-sub"> <a href="javascript:void(0);" class="waves-effect  waves-light"> <span class="s-caret"><i class="fa fa-angle-down"></i></span> <span class="s-icon"><i class="fa fa-file"></i></span> <span class="s-text"><?php echo $this->lang->line('left_e-file');?></span> </a>
        <ul>
          <?php if(in_array('100',$role_resources_ids)){?>
          <li><a href="<?php echo site_url();?>file_type"><?php echo $this->lang->line('left_file_type');?></a></li>
          <?php } ?>
          <?php if(in_array('101',$role_resources_ids)){?>
          <li><a href="<?php echo site_url();?>templates"><?php echo $this->lang->line('left_templates');?></a></li>
          <?php } ?>
		  <?php if(in_array('102',$role_resources_ids)){?>
          <li><a href="<?php echo site_url();?>files"><?php echo $this->lang->line('left_files');?></a></li>
          <?php } ?>
        </ul>
      </li>
      <?php }} ?>
 ...
 <!--     <?php if($role_user[0]->role_id==1) {?>
	...
	<?php if($role_user[0]->role_id!=1) {?>
	  	<?php if(in_array('102',$role_resources_ids) || in_array('103',$role_resources_ids) || in_array('104',$role_resources_ids)){?>
      <li style="" class="with-sub"> <a href="javascript:void(0);" class="waves-effect  waves-light"> <span class="s-caret"><i class="fa fa-angle-down"></i></span> <span class="s-icon"><i class="fa fa-file"></i></span> <span class="s-text"><?php echo $this->lang->line('left_e-file');?></span> </a>
        <ul>
          <?php if(in_array('102',$role_resources_ids)){?>
          <li><a href="<?php echo site_url();?>files"><?php echo $this->lang->line('left_files');?></a></li>
          ...
          <li><a href="<?php echo site_url();?>sanction_files"><?php echo $this->lang->line('left_sanction_files');?></a></li>
          <?php } ?>
		  <?php if(in_array('104',$role_resources_ids)){?>
          <li><a href="<?php echo site_url();?>files_out"><?php echo $this->lang->line('left_files_out');?></a></li>
          <?php } ?>
			<?php if(in_array('105',$role_resources_ids)){?>
          <li><a href="<?php echo site_url();?>files_status"><?php echo $this->lang->line('left_files_status');?></a></li>
          <?php } ?>
        </ul>
      </li>
      <?php } ?> 
 ...
 <!--     <li> <a href="<?php echo site_url();?>employee/attendance/" class="waves-effect waves-light"> <span class="s-icon"><i class="fa fa-clock-o"></i></span> <span class="s-text"><?php echo $this->lang->line('left_attendance');?></span> </a> </li>
   ...
   <!--   <li> <a href="<?php echo site_url();?>logout" class="waves-effect waves-light"> <span class="s-icon"><i class="fa fa-sign-out"></i></span> <span class="s-text"><?php echo $this->lang->line('left_logout');?></span> </a> </li>
    -->  <?php ?>
	<li> <a href="<?php echo site_url();?>profile" class="waves-effect waves-light"> <span class="s-icon"><i class="fa fa-file-pdf-o"></i></span> <span class="s-text"><?php echo $this->lang->line('left_edocuments');?></span> </a> </li>
	<?php if($role_user[0]->role_id!=1) { ?>
	<!--<li> <a href="<?php echo site_url();?>employee/projects/" class="waves-effect waves-light"> <span class="s-icon"><i class="fa fa-file-text"></i></span> <span class="s-text"><?php echo $this->lang->line('left_document_diary');?></span> </a> </li>
-->	
	  	<?php if(in_array('102',$role_resources_ids) || in_array('103',$role_resources_ids) || in_array('104',$role_resources_ids)){?>
      <li style="" class="with-sub"> <a href="javascript:void(0);" class="waves-effect  waves-light"> <span class="s-caret"><i class="fa fa-angle-down"></i></span> <span class="s-icon"><i class="fa fa-file"></i></span> <span class="s-text"><?php echo $this->lang->line('left_e-file');?></span> </a>
        <ul>
          ...
          <li><a href="<?php echo site_url();?>files_status"><?php echo $this->lang->line('left_files_status');?></a></li>
          <?php } ?>	
		  <?php if(in_array('109',$role_resources_ids)){?>
          <li><a href="<?php echo site_url();?>draft_files"><?php echo $this->lang->line('left_draft_files');?></a></li>
          <?php } ?>	
		  <?php if(in_array('112',$role_resources_ids)){?>
          <li><a href="<?php echo site_url();?>archive_files"><?php echo $this->lang->line('left_archive_files');?></a></li>
          <?php } ?>
        </ul>
      </li>
      <?php } ?> 
	...
	<?php } ?>
<!--	<li> <a href="<?php echo site_url();?>receipts" class="waves-effect waves-light"> <span class="s-icon"><i class="fa fa-file-text-o"></i></span> <span class="s-text"><?php echo $this->lang->line('left_receipts');?></span> </a> </li>
	<li> <a href="<?php echo site_url();?>dispatch" class="waves-effect waves-light"> <span class="s-icon"><i class="fa fa-truck"></i></span> <span class="s-text"><?php echo $this->lang->line('left_dispatch');?></span> </a> </li>
-->    <li style="" class="with-sub"> <a href="javascript:void(0);" class="waves-effect waves-light"> <span class="s-caret"><i class="fa fa-angle-down"></i></span> <span class="s-icon"><i class="fa fa-bar-chart"></i></span> <span class="s-text"><?php echo $this->lang->line('left_reports');?></span></a>
	 <ul>
			  <li><a href="<?php echo site_url();?>sanction_files_by_department"><?php echo $this->lang->line('left_department');?></a></li>
	          <li><a href="<?php echo site_url();?>sanction_files_by_designation"><?php echo $this->lang->line('left_designation');?></a></li>
	   <!--       <li><a href="<?php echo site_url();?>files_status"><?php echo $this->lang->line('left_files_status');?></a></li> -->
	          <li><a href="<?php echo site_url();?>sanction_files_by_pendency"><?php echo "Pendency";?></a></li>
	</ul>
	</li>
	<li> <a href="<?php echo site_url();?>employees" class="waves-effect waves-light"> <span class="s-icon"><i class="fa fa-book"></i></span> <span class="s-text"><?php echo $this->lang->line('left_address_book');?></span> </a> </li>
    <li style="" class="with-sub"> <a href="javascript:void(0);" class="waves-effect waves-light"> <span class="s-caret"><i class="fa fa-angle-down"></i></span> <span class="s-icon"><i class="fa fa-question-circle"></i></span> <span class="s-text"><?php echo "Help";?></span></a>
	 <ul>
			  <li><a href="<?php echo site_url();?>help"><?php echo "About";?></a></li>
	          <li><a href="<?php echo site_url();?>help"><?php echo "Support";?></a></li>
	          <li><a href="<?php echo site_url();?>user_manual"><?php echo "User Manual";?></a></li>
	</ul>
	</li>
    </ul>
  </div>
