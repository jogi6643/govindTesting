...
<strong style="color:red;">For any kind of support or query, kindly mail or call on the following details:</strong><br>
    <table class="table table-striped table-bordered dataTable">
      <thead>
        <tr>
          ...
          <th>Email</th>
          <th>Contact No</th>
          <th>Support/Query Type</th>
		</tr>
      </thead>
	  <tr>
	  <td>Ashish Chauhan</td>
	  <td>esupport@npglobal.in</td>
	  <td>9212230524</td>
