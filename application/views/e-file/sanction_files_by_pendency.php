  ...
  <div class="add-record-btn">
	<div class="col-md-8">
	  <div class="form-group">
		   <select class="form-control" name="pendency_range" id="pendency_range" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('xin_employee_department');?>">
                          <option value="">All Pendency Period</option>
                          <option value="1">1-7 Days</option>
                          <option value="2">7-15 Days</option>
                          <option value="3">16-30 Days</option>
                          <option value="4">31-45 Days</option>
                          <option value="5">46-60 Days</option>
                          <option value="6">Above 60 Days</option>
			</select>
	  </div>
	</div>  
   
   <div class="col-md-4">
       <a href="<?php echo site_url();?>sanction_files_by_pendency/file_list_pdf/" class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="top" title="" data-original-title="PDF"><span <i="" class="fa fa-file-pdf-o"></span> Download</a> 
   </div>
</div>
