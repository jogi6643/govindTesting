               ...
               <div class="row">
				<div class="col-md-3">
					...
					<label for="file_name">File No.</label>					
                        <input class="form-control" placeholder="File No." name="file_name" type="text">
						</div>
                    </div>
...
$(function() {
    $( "#datepicker" ).datepicker({ minDate: 0});
					...
					<div class="col-md-3">
                    <div class="form-group">
					<label for="file_type">File Action</label>					
                        <select id="select3" class="form-control" name="file" data-plugin="select_hrm" data-placeholder="<?php echo $this->lang->line('left_file_priority');?>">
                         <option value="">Choose File Type</option>
						<option value="Normal">E-Mail</option>						  
                        <option value="Urgent">Physical</option>						  
                        <option value="Most urgent">Online</option>						  
                        </select>
						</div>
                    </div>	
...
<div class="row">
	...
	<div id="myDivButton">
			<button type="submit" id="save" class="btn btn-primary save" style="display:none;">Save</button>
			<button type="submit" id="send" onclick="myFunction3()" class="btn btn-primary save" style="display:none;">Send</button>
			<button id="esign" onclick="myFunction()" name="esign" class="btn btn-primary" style="display:none;">e-Sign & Send</button>
...
<div class="box box-block bg-white">
  <h2><strong>List All</strong> Draft Files 
 <!-- <div class="add-record-btn">
