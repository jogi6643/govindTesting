...
<div class="box box-block bg-white">
 ...
 <div class="add-record-btn">
	...
	<div class="col-md-4">   
   <a href="<?php echo site_url();?>sanction_files_by_department/file_list_pdf/" class="btn btn-primary btn-sm" data-toggle="tooltip" data-placement="top" title="" data-original-title="PDF"><span <i="" class="fa fa-file-pdf-o"></span> Download</a> 
	</div>
 ...
 <!--<div class="col-md-9"></div>
		...
		<!--		 <div class="col-md-3">
				   <div class="form-group">
                     <select class="form-control" name="file_method" id="file_method" data-plugin="select_hrm">
                          <option value="">Select File Method</option>
                          <option value="IN">File In</option>
                          <option value="OUT">File Out</option>
                        </select>
                      </div>
					</div> 
