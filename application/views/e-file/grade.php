...
<div class="add-form" style="display:none;">
  <div class="box box-block bg-white">
    ...
    <div class="row m-b-1">
      <div class="col-md-12">
        <form action="<?php echo site_url("grade/add_grade") ?>" method="post" name="add_grade" id="xin-form">
		<?php
	$csrf=array(
	...
	<!--	<input type="hidden" name="counter" value="<?php echo $counter;?>"> -->
          ...
          <div class="bg-white">
            <div class="box-block">    
              ...
              <input class="form-control" placeholder="Add Grade" name="grade" type="text">
            </div>
          </div>
		</div>
    ...
    function deletep(id){
       var r=confirm("Do you want to delete this?")
        if (r==true)
		{
		   ...
		   $("#tender_display").html("<strong><i class='icon24 i-close-4'></i>Grade Deleted Successfully</strong>");
