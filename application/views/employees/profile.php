  ...
  <div class="col-md-3">
    <div class="box bg-white">
      <ul class="nav nav-4 nav-tabs-link-cl">
        ...
        <li class="nav-item nav-item-link" id="user_details_1"> <a class="nav-link nav-tabs-link" href="#user_basic_info" data-profile="1" data-profile-block="user_basic_info" data-toggle="tab" aria-expanded="true"> <i class="fa fa-user"></i> <?php echo $this->lang->line('xin_e_details_basic');?> </a> </li>
        <?php } ?>
...
-->     <?php if($system[0]->employee_manage_own_document=='yes'){?>
       <li class="nav-item nav-item-link active-link" id="user_details_5"> <a class="nav-link nav-tabs-link" href="#document" data-profile="5" data-profile-block="document" data-toggle="tab" aria-expanded="true"> <i class="fa fa-file"></i> <?php echo $this->lang->line('xin_e_details_document');?> </a> </li>
       <?php } ?>
		<?php if($system[0]->employee_manage_own_document_archive=='yes'){?>
		  <li class="nav-item nav-item-link" id="user_details_15"> <a class="nav-link nav-tabs-link" href="#document-archive" data-profile="15" data-profile-block="document-archive" data-toggle="tab" aria-expanded="true"> <i class="fa fa-file"></i> <?php echo $this->lang->line('xin_e_details_document_archive');?> </a> </li>
       <?php } ?>
  ...
  <div class="col-md-9 current-tab animated fadeInRight" id="user_basic_info"  style="display:none;" aria-expanded="false">
    ...
    <!--      <div class="col-md-4">
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <input class="form-control" placeholder="<?php echo $this->lang->line('xin_contact_number');?>" name="contact_no" type="text" value="<?php echo $contact_no;?>" readonly>
            </div>
          </div>
		  <div class="col-md-4">
			<label for="signature">Your e-Sign</label><br>
			<?php if($signature!='' && $signature!='no file') {?>
			<br />
			<img src="<?php echo base_url().'uploads/signature/'.$signature;?>" width="80px" id="u_file"><br />
			<?php } else{ ?>
			<span>No e-Sign uploaded</span>
			<?php }?>	
        </div>
        </div>
        <div class="row">
  ...
  <?php } ?>
  <?php if($system[0]->employee_manage_own_document=='yes'){?>
  <div class="col-md-9 current-tab animated fadeInRight" id="document">
    <div class="box box-block bg-white">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              </span> <br /><small><?php echo $this->lang->line('xin_e_details_d_type_file');?></small></div>
          </div>
        </div>
  <!--      <div class="row">
          <div class="col-md-6">
  ...
  <?php } ?>
<?php if($system[0]->employee_manage_own_document_archive=='yes'){?>
  <div class="col-md-9 current-tab animated fadeInRight" id="document-archive" style="display:none;">
      <div class="box box-block bg-white">
      <h2><strong><?php echo $this->lang->line('xin_list_all');?></strong> <?php echo $this->lang->line('xin_manual');?></h2>
      <div class="table-responsive" data-pattern="priority-columns">
        <table class="table table-striped table-bordered dataTable" id="xin_table_document_archive" style="width:100%;">
          <thead>
            <tr>
              <th><?php echo $this->lang->line('xin_action');?></th>
              <th><?php echo $this->lang->line('xin_e_details_dtype');?></th>
