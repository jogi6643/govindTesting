...
<div class="row m-b-1">
    ...
    <form id="basic_info" action="<?php echo site_url("employees/basic_info") ?>" name="basic_info" method="post">
      ...
      <div class="box box-block bg-white">
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="form-group">
              <label for="username"><?php echo $this->lang->line('dashboard_username')."/Email";?></label>
              <input class="form-control" placeholder="<?php echo $this->lang->line('dashboard_username')."/Email";?>" name="username" type="text" value="<?php echo $username;?>">
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
		...
		<div class="col-md-4"> 
            <div class="form-group">
              <label for="grade" class="control-label"><?php echo "Grade";?></label>
				<select class="form-control" name="grade" id="grade" data-plugin="select_hrm" data-placeholder="<?php echo "Grade";?>">
                <option value=""></option>
                <?php 
				$all_grades = $this->Grade_model->all_grade();  
				foreach($all_grades as $all_grade) { ?>
               <option value="<?php echo $all_grade->id?>" <?php if($grade==$all_grade->id):?> selected <?php endif;?>><?php echo $all_grade->grade;?></option>
			  <?php } ?>
              </select>  
			  </div>
          </div>	
  ...
  <!--      <div class="row">
		...
		<div class="row">
          <div class="col-md-6">
            <div class="form-group">
			<label for="dsc_signature">Uploaded DSC Signature</label><br>
			<input class="form-control" type="hidden" name="dsc_signature_part" value="<?php echo $dsc_signature;?>">
			<span><input class="form-control" type="file" name="dsc_signature"></span>
			</div>
			</div>
			...
			<div class="col-md-6">
            <div class="form-group">
			<label for="signature">Uploaded e-Signature</label><br>
			<?php if($signature!='' && $signature!='no file') {?>
			<br />
			<img src="<?php echo base_url().'uploads/signature/'.$signature;?>" width="80px" id="u_file"><br />
			<input class="form-control" type="hidden" name="signature_part" onchange="readURL(this);" value="<?php echo $signature;?>">
			<!--<a href="<?php echo site_url()?>download?type=signature&filename=<?php echo $signature;?>">Download</a>-->
			<?php }?>
			<span><input class="form-control" type="file" onchange="readURL(this);" name="signature"></span>
			</div>
			</div><img id="blah" src="#" alt="" />
		</div>
