...
if(isset($_GET['jd']) && isset($_GET['managing_directive_id']) && $_GET['data']=='managing_directive'){
?>

<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('xin_edit_managing_directive');?></h4>
</div>
<form class="m-b-1" action="<?php echo site_url("managing_directive/update").'/'.$managing_directive_id; ?>" method="post" name="edit_managing_directive" id="edit_managing_directive">
  <input type="hidden" name="_method" value="EDIT">
  <input type="hidden" name="_token" value="<?php echo $managing_directive_id;?>">
...
<script type="text/javascript">
 $(document).ready(function(){
        ...
        "bDestroy": true,
		"ajax": {
            url : "<?php echo site_url("managing_directive/managing_directive_list") ?>",
            type : 'GET'
        },
		...
		/* Edit data */
/*		$("#edit_managing_directive").submit(function(e){
		e.preventDefault();
			...
			$.ajax({
				type: "POST",
				url: e.target.action,
				data: obj.serialize()+"&is_ajax=1&edit_type=managing_directive&form="+action+'&description='+description,
				cache: false,
	...
	*/	
	...
	//	var n = $("#remark2")["code"]();
		fd.append("is_ajax", 1);
		fd.append("edit_type", 'managing_directive');
...
<?php } else if(isset($_GET['jd']) && isset($_GET['managing_directive_id']) && $_GET['data']=='view_managing_directive'){
?>

<div class="modal-header">
  <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">×</span> </button>
  <h4 class="modal-title" id="edit-modal-data"><?php echo $this->lang->line('xin_view_managing_directive');?></h4>
</div>
<form class="m-b-1">
  <div class="modal-body">
    <div class="row">
