     ...
     <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input class="form-control" name="delivery_mode" value="<?php echo $delivery_mode; ?>" readonly type="text">
			 ...
			 <div class="col-md-6">
              <div class="form-group">
                    ...
                    <input class="form-control" placeholder="<?php echo $this->lang->line('xin_file_letter_reference_no');?>" name="file_letter_reference_no" value="<?php echo $file_letter_reference_no; ?>" type="text">
                  </div>
            </div>
          </div>
		     <div class="row">
            ...
            <div class="col-md-6">
                 <div class="form-group">
                        ...
                        <input class="form-control" placeholder="<?php echo $this->lang->line('xin_designation');?>" name="designation" value="<?php echo $designation; ?>" type="text">
                      </div>
            </div>
          </div>
		   <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                        ...
                        <input class="form-control" placeholder="<?php echo $this->lang->line('xin_organization_name');?>" name="organization_name" value="<?php echo $organization_name; ?>" type="text">
                      </div>
            </div>
            <div class="col-md-6">
                 <div class="form-group">
                        <label for="client_name"><?php echo $this->lang->line('xin_organization_address');?></label>
                        <input class="form-control" placeholder="<?php echo $this->lang->line('xin_organization_address');?>" name="organization_address" value="<?php echo $organization_address; ?>" type="text">
                      </div>
            </div>
          </div>
		   ...
		   <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                        ...
                        <input class="form-control" placeholder="<?php echo $this->lang->line('xin_contact_number');?>" name="contact_no" value="<?php echo $contact_no; ?>" type="text">
                      </div>
            </div>
            <div class="col-md-6">
              <div class="form-group">
                        <label for="client_name"><?php echo $this->lang->line('xin_mobile_no');?></label>
                        <input class="form-control" placeholder="<?php echo $this->lang->line('xin_mobile_no');?>" name="mobile_no" value="<?php echo $mobile_no; ?>" type="text">
                      </div>
            </div>
          </div>
		   <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                        ...
                        <input class="form-control" placeholder="<?php echo $this->lang->line('xin_fax_no');?>" name="fax_no" value="<?php echo $fax_no; ?>" type="text">
                      </div>
            </div>
            <div class="col-md-6">
             <div class="form-group">
                        <label for="client_name"><?php echo $this->lang->line('xin_email');?></label>
                        <input class="form-control" placeholder="<?php echo $this->lang->line('xin_email');?>" name="email_id" value="<?php echo $email_id; ?>" type="text">
                      </div>
            </div>
          </div>
        ...
        <div class="col-md-6">
          ...
          <div class="row">
			...
			<div class="col-md-6">
				<div class="form-group">
				<label for="document">Uploaded Document</label><br>
				<?php if($document !='' && $document != null && $document!='no file') {?>
				<a href="<?php echo base_url().'uploads/document_diary/'.$document;?>" target="_blank">		
				<span> <?php echo "<img src=".base_url().'uploads/image/attachment.png'.">"; ?>
				<?php echo ''.$document;?>
				<span></a>
				<input class="form-control" name="document" type="hidden" value="<?php echo $document;?>">
				<?php }else{ echo '<span class="btn btn-primary btn-file"> '."No Document exists".'<span>'; ?>
				<input class="form-control" name="document" type="hidden" value="<?php echo $document;?>">
			<?php } ?>	
				</div></div>
        </div>
