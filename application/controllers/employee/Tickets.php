 ...
 * @package  Workable Zone - User > Tickets
...
class Tickets extends MY_Controller {
	...
	public function output($Return=array()){
	 ...
	 public function index()
     {
		...
		if(!empty($session)){ 
			$data['subview'] = $this->load->view("user/tickets", $data, TRUE);
    ...
    public function ticket_list()
     {
		...
		$data[] = array(
			'<span data-toggle="tooltip" data-placement="top" title="View Details"><a href="'.site_url().'tickets/details/'.$r->ticket_id.'"><button type="button" class="btn btn-secondary btn-sm m-b-0-0 waves-effect waves-light" title="View Details"><i class="fa fa-arrow-circle-right"></i></button></a></span>',
			$r->ticket_code,
			$r->subject,
			$employee_name,
			$priority,
		...
		$function = '<div class="c-item">
					<div class="media">
						...
						<div class="media-body">
							<div class="mb-0-5">
								<a class="c-user text-black" href="'.site_url().'employees/detail/'.$r->user_id.'"><span class="underline">'.$employee_name.' ('.$_designation[0]->designation_name.')</span></a>
