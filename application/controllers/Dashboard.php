...
class Dashboard extends MY_Controller {
	...
	public function index()
	{
		...
		$_department = $this->Department_model->read_department_information($user[0]->department_id);
		$_location = $this->Location_model->read_location_information($_department[0]->location_id);
		$data = array(
			...
			'department_name' => $_department[0]->department_name,
			'location_name' => $_location[0]->location_name,
			'date_of_birth' => $user[0]->date_of_birth,
			'date_of_joining' => $user[0]->date_of_joining,
			'contact_no' => $user[0]->contact_no,
			'last_login_ip' => $user[0]->last_login_ip,
