...
class Profile extends MY_Controller {
	...
	public function user_basic_info() {
		...
		// $fname = $newfilename;
		// }
		// elseif(($ext == null) && ($_FILES['signature']['size'] == 0)){
		// if(($this->input->post('signature') != null) || ($this->input->post('signature') != 0)){
		// $fname = $this->input->post('signature'); 
		// }else{
		// $fname = ''; 	
		// }
		// }
	...
	public function documents() {
	 ...
	 public function documents_archives() {
		//set data
		$data['title'] = $this->Xin_model->site_title();
		$session = $this->session->userdata('username');
		if(!empty($session)){ 
