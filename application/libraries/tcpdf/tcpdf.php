...
class TCPDF {
	 ...
	 * @public
	 */
	public function setHeaderData($ln='', $lw=0, $ht='', $hs='', $hfs='', $tc=array(0,0,0), $lc=array(0,0,0)) {
		$this->header_logo = $ln;
		$this->header_logo_width = $lw;
		$this->header_title = $ht;
		$this->header_string = $hs;
		$this->header_file_string = $hfs;
	 ...
	 * @public
	 */
	public function setFooterData($fs='', $tc=array(0,0,0), $lc=array(0,0,0)) {
	...
	public function getHeaderData() {
		...
		$ret['text'] = $this->header_file_string;
	...
	public function Header() {
		if ($this->header_xobjid === false) {
			...
			$this->MultiCell(187, 0, $headerdata['text'], 0, '', 0, 0, '14.5', '', true, 0, false, false, 0, 'T', false);
	...
	public function Footer() {
		...
		if ($this->getRTL()) {
			...
			$this->SetX($this->original_lMargin);
		//	$this->MultiCell(0, 0, $footerdata['string'], 'T', 0, 'L');
		//	$this->Cell(0, 0, $this->getAliasRightShift(), 'T', 0, 'R');
		//	$this->MultiCell(0, 0, $footerdata['string'], 0, '', 0, 1, '', '', true, 0, false, true, 0, 'T', false);
