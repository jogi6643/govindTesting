    ...
    <div class="col-md-6 col-md-offset-3">
      <div class="panel panel-custom">
        <div class="panel-body">
          <div class="alert alert-success" role="alert"> Well done! You Successfully Installed Workable Zone - HRM System. </div>
          <div class="well well-lg">
            <h4><strong>Admin panel Login Details</strong></h4>
            <hr/>
            <p>Please keep bellow login details to login Workable Zone System.</p>
        ...
        <div class="panel-footer">&copy Workable Zone - HR Software </div>
      </div>
    </div>
  </div>
</div>
