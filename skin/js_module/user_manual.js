...
$(document).ready(function() {
    var a = $("#xin_table")['dataTable']({
        "bDestroy": true,
        "ajax": {
            url: site_url + "user_manual/user_manual_list/",
            type: "GET"
        },
    ...
    $(".view-modal-data")["on"]("show.bs.modal", function(d) {
        ...
        var e = $(this);
        $["ajax"]({
            url: site_url + "User_manual/read/",
            type: "GET",
            data: "jd=1&is_ajax=1&mode=view_modal&data=view_user_manual&id=" + f,
            success: function(g) {
                if (g) {
    ...
    // var n = $("#remark")["code"]();
    s["append"]("is_ajax", 1);
    s["append"]("add_type", "add_user_manual");
