...
$(document).ready(function() {
    var a = $("#xin_table")['dataTable']({
        "bDestroy": true,
        "ajax": {
            url: site_url + "file_type/file_type_list/",
            type: "GET"
        },
    ...
    $(".edit-modal-data")["on"]("show.bs.modal", function(d) {
        ...
        $["ajax"]({
            url: base_url + "/read/",
            type: "GET",
            data: "jd=1&is_ajax=1&mode=modal&data=edit_file_type&id=" + f,
            success: function(g) {
                if (g) {
                    $("#ajax_modal")["html"](g)
                }
    ...
    $(".view-modal-data")["on"]("show.bs.modal", function(d) {
        ...
        var e = $(this);
        $["ajax"]({
            url: site_url + "file_type/read/",
            type: "GET",
            data: "jd=1&is_ajax=1&mode=view_modal&data=view_file_type&id=" + f,
            success: function(g) {
                if (g) {
    ...
    $("#xin-form")["submit"](function(d) {
        ...
        $["ajax"]({
            type: "POST",
            url: d["target"]["action"],
            data: f["serialize"]() + "&is_ajax=1&add_type=file_type&form=" + c + "&description=" + m,
            cache: false,
            success: function(g) {
                if (g["error"] != "") {
                    toastr["error"](g["error"]);
                    ...
                    $(".icon-spinner3")["hide"]();
                    $("#xin-form")["file_type/file_type_list/"]["reset"]();
                    $(".save")["prop"]("disabled", false)
                }
            }
        })
