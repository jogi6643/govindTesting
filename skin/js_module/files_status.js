...
$(document).ready(function() {
    var a = $("#xin_table")['dataTable']({
        "bDestroy": true,
        "ajax": {
            url: site_url + "files_status/file_status_list/",
            type: "GET"
        },
    ...
    $(".edit-modal-data")["on"]("show.bs.modal", function(d) {
        ...
        $["ajax"]({
            url: base_url + "/read/",
            type: "GET",
            data: "jd=1&is_ajax=1&mode=modal&data=edit_file_status&id=" + f,
            success: function(g) {
                if (g) {
                    $("#ajax_modal")["html"](g)
                }
    ...
    $(".view-modal-data")["on"]("show.bs.modal", function(d) {
        ...
        var e = $(this);
        $["ajax"]({
            url: site_url + "files_status/read/",
            type: "GET",
            data: "jd=1&is_ajax=1&mode=view_modal&data=view_file_status&id=" + f,
            success: function(g) {
                if (g) {
