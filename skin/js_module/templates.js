...
$(document).ready(function() {
    var a = $("#xin_table")['dataTable']({
        "bDestroy": true,
        "ajax": {
            url: site_url + "templates/template_list/",
            type: "GET"
        },
    ...
    $(".edit-modal-data")["on"]("show.bs.modal", function(d) {
        ...
        $["ajax"]({
            url: base_url + "/read/",
            type: "GET",
            data: "jd=1&is_ajax=1&mode=modal&data=edit_template&id=" + f,
            success: function(g) {
                if (g) {
                    $("#ajax_modal")["html"](g)
                }
    ...
    $(".view-modal-data")["on"]("show.bs.modal", function(d) {
        ...
        var e = $(this);
        $["ajax"]({
            url: site_url + "templates/read/",
            type: "GET",
            data: "jd=1&is_ajax=1&mode=view_modal&data=view_template&id=" + f,
            success: function(g) {
                if (g) {
    ...
    $("#xin-form")["submit"](function(d) {
        ...
        $["ajax"]({
            type: "POST",
            url: d["target"]["action"],
            data: f["serialize"]() + "&is_ajax=1&add_type=templates&form=" + c + m,
            cache: false,
            success: function(g) {
                if (g["error"] != "") {
                    toastr["error"](g["error"]);
                    ...
                    $(".icon-spinner3")["hide"]();
                    $("#xin-form")["templates/template_list/"]["reset"]();
                    $(".save")["prop"]("disabled", false)
                }
            }
        })
